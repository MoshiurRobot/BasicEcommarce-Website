...
<body>
   ...
   <div class="usersec">
      <h1 style="color: white; font-size: 25px;background-color: green; width:90%; Margin:auto; padding:5px 0; text-align:center">Welcome <span><?php echo $_SESSION['user_name'] ?></span></h1>
   </div>
