...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="./glbdT.png">
  <title>GadgetLab BD</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-md  navbar-dark">
    <a class="navbar-brand mylogo" href="index.php"><img src="./glbdc.png" alt="" srcset="">&nbsp;&nbsp;</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class=" active" href="login_form.php"><i class="fas fa-right-to-bracket mr-2"></i>Login</a>
        </li>
        <li class="nav-item">
          <a class=" active" href="index.php"><i class="fas fa-mobile-alt mr-2"></i>All Products</a>
        </li>
        <li class="nav-item">
          <!-- <a class="nav-link" href="#"><i class="fas fa-th-list mr-2"></i>Categories</a> -->
        </li>
        <li class="nav-item">
          <a class="" href="login_form.php"><i class="fas fa-money-check-alt mr-2"></i>Checkout</a>
        </li>
        <li class="nav-item">
          <a class="" href="login_form.php"><i class="fas fa-shopping-cart"></i> <span id="cart-item" class="badge badge-danger"></span></a>
        </li>
      </ul>
    </div>
  </nav>
