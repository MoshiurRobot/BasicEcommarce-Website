...
<!-- <a class="navbar-brand mylogo" href="user_page.php><img src="./glbdc.png" alt="" srcset="">&nbsp;&nbsp;</a> -->
        ...
        <form action="" method="post" id="placeOrder">
          ...
          <div class="form-group">
            <select name="pmode" class="form-control">
              ...
              <option name=pmode value="cod" default>Cash On Delivery</option>
            </select>
          </div>
          <div class="form-group">
            <input type="submit" name="submit" value="Cash on delevery" class="btn-c  btn-block">
          </div>
        </form>
      </div>
    </div>
  ...
  <div class="pbtns">
  <a href=""><img src="./image/bkash.png" alt="" srcset=""></a>
  <a href=""><img src="./image/upay.png" alt="" srcset=""></a>
  <a href=""><img src="./image/mkash.png" alt="" srcset=""></a>
  </div> -->
